...
import { EnterpriseRiskPanel } from '@/components/EnterpriseRiskPanel';
...
export class PanelLayoutManager implements AppModule {
    ...
    this.ctx.container.innerHTML = `
      ...
      <div class="header">
        <div class="header-left">
          ...
          <div class="risksense-brand">
          <span class="risksense-logo-icon">
        ...
        <div class="header-right">
          <button class="search-btn" id="searchBtn"><kbd>Ctrl K</kbd> Search</button>
  ...
  private async createPanels(): Promise<void> {
    ...
    this.ctx.map = new MapContainer(mapContainer, {
      ...
      pan: { x: -180, y: 30 },
      view: this.ctx.isMobile ? this.ctx.resolvedLocation : 'asia',
